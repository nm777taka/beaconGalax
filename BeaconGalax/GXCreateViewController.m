...
- (void)viewDidLoad {
    ...
    [self showBeaconQuestViewController];
...
//    [self dismissViewControllerAnimated:YES completion:nil];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"pushCreateButton" object:nil];
...
{
    NSLog(@"sendersegmment:%ld",sender.selectedSegmentIndex);
...
- (UIViewController *)viewControllerForSegmentIndex:(NSInteger)index
{
    ...
    switch (index) {
        case 0:
            vc = [self.storyboard instantiateViewControllerWithIdentifier:@"beaconQuest"];
            break;
...
- (void)showBeaconQuestViewController
{
